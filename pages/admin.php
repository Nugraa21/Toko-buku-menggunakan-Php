...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
    <!-- Users -->
    <div
        class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-book-hover transition-all duration-300 group">
        <div
            class="w-16 h-16 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
    ...
    <div
        class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-book-hover transition-all duration-300 group">
        <div
            class="w-16 h-16 rounded-2xl bg-amber-50 text-amber-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div
        class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex items-center gap-4 hover:shadow-book-hover transition-all duration-300 group">
        <div
            class="w-16 h-16 rounded-2xl bg-green-50 text-green-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <!-- Pending (Clickable) -->
    <a href="#pending-list"
        class="bg-white p-6 rounded-[2rem] shadow-sm border border-rose-100 flex items-center gap-4 hover:shadow-book-hover transition-all duration-300 ring-2 ring-transparent hover:ring-rose-500/20 group cursor-pointer">
        <div
            class="w-16 h-16 rounded-2xl bg-rose-50 text-rose-600 flex items-center justify-center group-hover:bg-rose-600 group-hover:text-white transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <a href="index.php?page=admin_users"
                    ...
                    <!-- Decor -->
                    <div
                        class="absolute top-0 right-0 w-24 h-24 bg-blue-50/50 rounded-full translate-x-8 -translate-y-8 group-hover:bg-blue-100/50 transition-colors">
                    </div>

                    <div class="flex justify-between items-start mb-6 relative z-10">
                        <div
                            class="w-14 h-14 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center text-xl group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div
                            class="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-primary group-hover:text-white transition-colors">
                    ...
                    <div class="relative z-10">
                        <h4 class="text-xl font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">
                            Users & Saldo</h4>
                        <p class="text-sm text-slate-500 leading-relaxed">Edit data user, reset password, dan atur saldo
                            token manual.</p>
                    </div>
                </a>
                ...
                <a href="index.php?page=admin_books"
                    ...
                    <!-- Decor -->
                    <div
                        class="absolute top-0 right-0 w-24 h-24 bg-amber-50/50 rounded-full translate-x-8 -translate-y-8 group-hover:bg-amber-100/50 transition-colors">
                    </div>

                    <div class="flex justify-between items-start mb-6 relative z-10">
                        <div
                            class="w-14 h-14 rounded-2xl bg-amber-50 text-amber-600 flex items-center justify-center text-xl group-hover:scale-110 transition-transform duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    ...
                    <div class="relative z-10">
                        <h4 class="text-xl font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">
                            Katalog Buku</h4>
                        <p class="text-sm text-slate-500 leading-relaxed">Tambah buku baru, upload cover, update stok
                            dan harga.</p>
                    </div>
                </a>
                ...
                <a href="index.php?page=admin_categories"
                    ...
                    <!-- Decor -->
                    <div
                        class="absolute top-0 right-0 w-24 h-24 bg-purple-50/50 rounded-full translate-x-8 -translate-y-8 group-hover:bg-purple-100/50 transition-colors">
                    </div>

                    <div class="flex justify-between items-start mb-6 relative z-10">
                        <div
                            class="w-14 h-14 rounded-2xl bg-purple-50 text-purple-600 flex items-center justify-center text-xl group-hover:scale-110 transition-transform duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="relative z-10">
                        <h4 class="text-xl font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">
                            Kategori Buku</h4>
                        <p class="text-sm text-slate-500 leading-relaxed">Kelola kategori dan genre buku untuk
                            memudahkan pencarian.</p>
                    </div>
                </a>
                ...
                <a href="index.php?page=admin_transactions"
                    ...
                    <!-- Decor -->
                    <div
                        class="absolute top-0 right-0 w-32 h-32 bg-green-50/50 rounded-full translate-x-8 -translate-y-8 group-hover:bg-green-100/50 transition-colors">
                    </div>

                    <div class="flex justify-between items-start mb-6 relative z-10">
                        <div
                            class="w-14 h-14 rounded-2xl bg-green-50 text-green-600 flex items-center justify-center text-xl group-hover:scale-110 transition-transform duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="relative z-10">
                        <h4 class="text-xl font-bold text-slate-900 mb-2 group-hover:text-primary transition-colors">
                            Riwayat Penjualan</h4>
                        <p class="text-sm text-slate-500 leading-relaxed max-w-lg">Lihat semua transaksi pembelian user
                            dan statistik buku terlaris.</p>
                    </div>
                </a>
            </div>
        </div>
