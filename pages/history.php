                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-slate-800">
                                    <?= date('d F Y • H:i', strtotime($t['transaction_date'])) ?>
                                </p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="text-xs text-slate-500 uppercase font-bold tracking-wider">Total Pembayaran</p>
                            <p class="text-xl font-extrabold text-primary flex items-center justify-end gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="flex justify-between items-center text-xs">
                                            ...
                                            <span class="font-bold text-slate-700 flex items-center gap-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-slate-500"
                                                ...
                                                <?= number_format($item['price_per_token']) ?>
                                            </span>
                                        </div>
                                    </div>
                                </div>
